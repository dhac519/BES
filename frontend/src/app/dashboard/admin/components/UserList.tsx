...
export const UserList: React.FC<UserListProps> = ({ usuarios, onDelete, onAssign, onCreateOpen }) => {
  return (
        ...
        {usuarios.length === 0 ? (
          ...
          <div key={u.id} className="flex items-center justify-between px-6 py-4 hover:bg-white/[0.02] transition-colors">
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={() => onDelete(u.id)} className="p-2 text-gray-500 hover:text-red-400 hover:bg-red-400/10 rounded-lg transition-colors">
